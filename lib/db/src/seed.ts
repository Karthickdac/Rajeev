...
async function seed() {
  ...
  await db.insert(newsTable).values([
    {
      ...
      contentTa: "வணிக வரிகள், பதிவு மற்றும் முத்திரை வரி அமைச்சர் டி. லோகேஷ் தமிழ்செல்வன் ராசிபுரம் தொகுதியில் 40 கி.மீ புதிய சாலைகளை திறந்து வைத்தார். இந்த திட்டம் மாநில உள்கட்டமைப்பு மேம்பாட்டு திட்டத்தின் கீழ் நிதியளிக்கப்பட்டது.",
  ...
  await db.insert(galleryTable).values([
    {
      title: "ராசிபுரம் சாலை திறப்பு விழா",
    ...
    {
      title: "இலவச மருத்துவ முகாம் – ராசிபுரம்",
    ...
    {
      title: "மர நடவடிக்கை – பச்சை ராசிபுரம்",
