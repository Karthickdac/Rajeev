...
const TENANT_CONFIGS: Record<string, object> = {
  logesh: {
    ...
    addressTa: "சட்டமன்ற உறுப்பினர் அலுவலகம், திருவாடானை, இராமநாதபுரம் மாவட்டம், தமிழ்நாடு",
...
async function seed() {
  ...
  await db.insert(newsTable).values([
    {
      ...
      titleTa: "திருவாடானையில் சூரிய சக்தி தெரு விளக்கு திட்டம் – V. K. ராஜீவ் தொடக்கம்",
      ...
      contentTa: "சுற்றுச்சூழல் மற்றும் காலநிலை மாற்றம் அமைச்சர் V. K. ராஜீவ் திருவாடானை தொகுதியில் 12 கிராமங்களை உள்ளடக்கிய சூரிய சக்தி தெரு விளக்கு திட்டத்தை தொடக்கி வைத்தார். 800 பழைய விளக்குகளை LED சூரிய விளக்குகளாக மாற்றும் இந்த திட்டம் மின் செலவை குறைக்கும்.",
    ...
    },
    {
      ...
      titleTa: "திருவாடானையில் 5,000 மக்களுக்கு இலவச மருத்துவ முகாம்",
      ...
      contentTa: "வி.கே. ராஜீவின் அலுவலகம் திருவாடானை அரசு மருத்துவமனைகளுடன் இணைந்து மெகா இலவச மருத்துவ முகாம் ஏற்பாடு செய்தது. 5,000க்கும் மேற்பட்ட மக்கள் இலவச ஆலோசனை, மருந்துகள் பெற்றனர்.",
      category: "welfare",
      featured: true,
    ...
    },
    {
      ...
      titleTa: "திருவாடானை கடற்கரையில் 200 ஏக்கர் சதுப்பு நிலம் மறுவாழ்வு",
      ...
      contentTa: "அமைச்சர் வி.கே. ராஜீவின் தலைமையில் திருவாடானை கடற்கரையில் சதுப்பு நில மறுவாழ்வு பணிகள் தொடங்கப்பட்டன. 200 ஏக்கர் சிதிலமடைந்த கடற்கரை நிலத்தில் உள்ளூர் சதுப்பு நில மரங்கள் நடப்பட்டன.",
      category: "development",
      featured: true,
    ...
    },
    {
      ...
      titleTa: "திருவாடானையில் 20 அரசு பள்ளிகளில் கட்டமைப்பு மேம்பாடு",
      ...
      contentTa: "தொகுதி வளர்ச்சி நிதியின் கீழ், திருவாடானையில் 20 அரசு பள்ளிகளுக்கு புதிய வகுப்பறைகள், கழிப்பறைகள் மற்றும் டிஜிட்டல் உபகரணங்கள் வழங்கப்பட்டன.",
      category: "education",
      featured: false,
    ...
    },
    {
      ...
      titleTa: "திருவாடானையில் குடிநீர் குழாய் திட்டம் நிறைவு",
      ...
      contentTa: "திருவாடானை வட்டாரத்தை உள்ளடக்கிய புதிய குடிநீர் குழாய் திட்டம் நிறைவடைந்தது. 8,000க்கும் மேற்பட்ட குடும்பங்களுக்கு சுத்தமான குழாய் நீர் வழங்கப்படுகிறது.",
      category: "development",
      featured: false,
    ...
    },
    {
      ...
      titleTa: "திருவாடானையில் இயற்கை வேளாண்மை பயிற்சி மையம் திறப்பு",
      ...
      contentTa: "திருவாடானையில் இயற்கை வேளாண்மை பயிற்சி மையம் திறக்கப்பட்டது. நிலையான விவசாயம், உரம் தயாரிப்பு மற்றும் இயற்கை பூச்சி மேலாண்மையில் பயிற்சி வழங்கப்படும்.",
      category: "employment",
      featured: false,
  ...
  await db.insert(eventsTable).values([
    ...
    },
    {
      ...
      titleTa: "கடற்கரை சுத்திகரிப்பு & மர நடவடிக்கை – பசுமை திருவாடானை",
  ...
  await db.insert(activitiesTable).values([
    {
      ...
      titleTa: "திருவாடானை மீனவர்களை சந்தித்தல் – கடற்கரை அரிப்பு பிரச்சினை",
  ...
  await db.insert(wardsTable).values([
    // Central Zone
    { slug: "ward-01-thiruvadanai-town",   name: "Ward 1 – Thiruvadanai Town",    nameTa: "வார்டு 1 – திருவாடானை நகர்",        wardType: "panchayat", zoneId: zoneId("central"), pincode: "623534", latitude: 9.3700, longitude: 78.5200 },
    { slug: "ward-02-thiruvadanai-north",  name: "Ward 2 – Thiruvadanai North",   nameTa: "வார்டு 2 – திருவாடானை வடக்கு",      wardType: "panchayat", zoneId: zoneId("central"), pincode: "623534", latitude: 9.3780, longitude: 78.5220 },
    ...
    { slug: "ward-05-thiruvadanai-south",  name: "Ward 5 – Thiruvadanai South",   nameTa: "வார்டு 5 – திருவாடானை தெற்கு",      wardType: "panchayat", zoneId: zoneId("central"), pincode: "623534", latitude: 9.3600, longitude: 78.5180 },
    // North Zone
  ...
  await db.insert(galleryTable).values([
    ...
    {
      title: "மக்கள் சந்திப்பு – திருவாடானை",
    ...
    {
      title: "சதுப்பு நில மறுவாழ்வு திட்டம் – திருவாடானை கடற்கரை",
  ...
  await db.insert(faqsTable).values([
    ...
    },
    {
      ...
      questionTa: "திருவாடானையில் TVK தன்னார்வலராக எப்படி இணைவது?",
    ...
    },
    {
      ...
      questionTa: "திருவாடானையில் சுற்றுச்சூழல் பிரச்சினையை எப்படி தெரிவிப்பது?",
