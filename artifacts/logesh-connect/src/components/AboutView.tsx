...
export function createDefaultAboutConfig(lc: LeaderConfig): AboutConfig {
  return {
    ...
    bioFullTa: `மக்களுடன் நேரடியாக தொடர்பு வைத்துக்கொண்டு, அவர்களின் பிரச்சினைகளை உடனடியாக தீர்க்கும் இவர், ${lc.constituencyTa} தொகுதியின் உள்கட்டமைப்பு வளர்ச்சி, கல்வி மேம்பாடு, சுற்றுச்சூழல் பாதுகாப்பு சேவைகளில் குறிப்பிடத்தக்க பங்காற்றியுள்ளார்.`,
    education: "",
    born: "",
    phone: lc.phone,
    email: lc.email,
